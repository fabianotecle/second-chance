...
window.Webflow.push(() => {
  ...
  async function Init() {
    ...
    function selectCountry(country: Country) {
      const inputCountryCode = document.querySelector(
      ...
      const options: NodeListOf<HTMLLinkElement> =
        document.querySelectorAll('.prefix-dropdown_item');
    ...
    submitButton.addEventListener('click', function (event) {
      ...
      fetch('', {
        ...
        .catch(() => {
          const formTag = document.getElementById('phone-form') as HTMLDivElement;
          formTag.style.display = 'none';
          const failDiv = document.querySelector('.w-form-done') as HTMLDivElement;
